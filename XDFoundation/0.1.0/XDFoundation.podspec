...
Pod::Spec.new do |s|
  s.name             = 'XDFoundation'
  s.version          = '0.1.0'
  s.summary          = 'A short description of XDFoundation.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/ywdonga/XDFoundation'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '329720990@qq.com' => 'dongyouweie@126.com' }
  s.source           = { :git => 'https://github.com/ywdonga/XDFoundation.git', :tag => s.version.to_s }
